var map = L.map('mapid').setView([49.25077560316286, -123.08944702148438], 8);
...
var marker_1 = L.marker([49.25077560316286, -123.08944702148438], {icon: blackIcon} )
var marker_2 = L.marker([49.25077560316286, -124.08944702148438], {icon: blackIcon} )
var marker_3 = L.marker([47.25077560316286, -124.08944702148438])

var featureGroup = L.featureGroup([marker_1, marker_2, marker_3])
    // .bindPopup('Hello world!')
    // .on('click', function() { alert('Clicked on a member of the group!'); })
    .addTo(map);

// faz aparecer melhor todos os elementos do mapa
...
// mymap.fitBounds(addGeoJson.getBounds(),{
// 	padding:[20,20]
// })